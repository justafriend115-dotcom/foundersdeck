...
export const fundraisingTrack: AcademyTrack = {
  ...
  lessons: [
    {
      ...
      sections: [
        {
          ...
          paragraphs: [
            "Before the roadshow, answer three questions: (1) What will the money buy that revenue cannot? (2) What milestone will it unlock that makes the next round (or profitability) possible? (3) Is your product ready for the scrutiny? Raising is a distraction from building — if your product isn't working yet, money accelerates the problem.",
            "The milestones that justify a raise: achieving PMF metrics, hitting a revenue inflection, funding a land-grab (market timing), or buying enterprise customers who need balance-sheet credibility. 'We want to hire more people' is not a milestone — it's a plan to buy more of the same problem.",
        ...
        },
        {
          ...
          paragraphs: [
            "Raise enough for 18-24 months of runway — enough time to hit the next milestone and run the next round without desperation (fundraising in the last quarter of runway is negotiating from weakness). Rule of thumb: the round = 18-24 months of burn + a buffer.",
            "Two common mistakes: raising too little (forced back into the market too early, wearing out your investor list) and raising too much at the wrong stage (over-dilution with nothing to show). The right amount is the minimum that reaches your next value inflection — not the maximum you can extract.",
          ],
        },
        {
          heading: "The investor-readiness check",
          paragraphs: [
            "Before reaching out, be able to answer in one sentence each: what problem, for whom, why now, why you, and what the money buys. Have 12-18 months of data (metrics, customers, revenue) if you've been operating. Have the legal housekeeping (entity, cap table, docs) clean. And have a lead investor thesis — the single most valuable asset in your raise.",
            "Cold outreach works best with a warm intro and a reason 'why them.' Investors fund people they can believe in — and belief comes from credibility signals: customers, traction, and a point of view.",
          ],
        },
      ],
      examples: [
        "A pre-product founder raises $500K to 'build the team and figure it out.' 12 months later the product is still unfunded in traction and the runway is at 4 months. The next round — if any — is a down round with brutal terms.",
      ...
      keyPoints: [
        ...
        "18-24 months of runway; round = burn × 18-24 + buffer.",
    ...
    },
    {
      ...
      sections: [
        {
          ...
          paragraphs: [
            ...
            "Fund math matters: a $100M fund needs to return ~3x, so a $2M check at a $10M valuation must become ~$60M of exit value attributed to them. That's why VCs push for big markets and 10x outcomes — their model requires it. Angels and syndicates are more tolerant of smaller outcomes.",
          ],
        },
        {
          ...
          paragraphs: [
            ...
            "Signals to read: recent investments (momentum — funds back what they're already backing), follow-on behavior (do they support their companies?), and their public content (podcasts, Twitter, newsletters). An investor who talks about 'founder-market fit' cares about a different pitch than one who talks about 'TAM expansion.'",
            "Red flags: investors who ghost for weeks, who ask for exclusive decks without meetings, who push term sheets with weird clauses 'as a favor,' and funds that are out of deployment for the year (they're still meeting — it's free diligence for them).",
          ],
        },
        {
          heading: "Building your target list",
          paragraphs: [
            "Your list should be 30-60 investors, tiered: Tier 1 (dream fits — 10), Tier 2 (strong fits — 15), Tier 3 (maybes — 20+). Reach out in waves — the goal is to create momentum (multiple offers) and avoid burning your list in one mass email.",
            "Use warm intros where possible (portfolio founders are the strongest referrers), and give your referrer a 3-line hook they can forward — make it easy for them to be helpful.",
          ],
        },
      ],
      examples: [
        "A founder pitches a $20M-exit-potential lifestyle business to a $200M fund. The fund passes — not because the business is bad, but because the math doesn't work for their model. He raises from angels and a $10M micro-VC instead, and everyone's happy.",
        "Another founder cold-emails 80 investors in one night with no research. Response rate: 3%. His competitor sends 15 targeted, researched intros via warm connections — and closes an oversubscribed round.",
      ],
      actionItems: [
      ...
      keyPoints: [
        ...
        "Fund math demands 10x — know what your audience needs.",
    ...
    },
    {
      ...
      sections: [
        {
          ...
          paragraphs: [
            "Valuation is set by supply and demand, not by formulas — but four forces determine the range: (1) traction (revenue, growth rate, retention — the strongest signal), (2) comparable deals (what similar companies at similar stages raised), (3) scarcity (how many investors are competing), and (4) founder quality and team credibility.",
        ...
        },
        {
          ...
          paragraphs: [
            "Typical ranges (2024-2026, rough): pre-seed/SAFE pre-money $2-8M; seed $8-15M pre; post-seed pre-revenue rarely exceeds $15M; seed with revenue $15-30M. Series A $30-60M pre. These move with markets — in cold markets everything compresses 20-40%.",
        ...
        },
        {
          ...
          paragraphs: [
            "There is one lever that moves valuation more than any other: growth rate. A company growing 20%/month at $50K MRR is worth 2-3x a company growing 5%/month at $100K MRR — investors buy the trajectory, not the level. If you want a higher valuation, the highest-leverage move is not negotiation — it's two months of faster growth before the round.",
      ...
      examples: [
        "Two identical products, identical revenue ($80K MRR). Company A grows 6%/mo; Company B grows 25%/mo. A's seed: $8M pre. B's seed: $18M pre. Same business, different trajectories — the market pays for the slope.",
    ...
    },
    {
      ...
      sections: [
        {
          ...
          paragraphs: [
            "SAFE (Simple Agreement for Future Equity): you take money now, investor receives equity when the next priced round happens, with a discount (typically 10-20%) and/or a valuation cap (e.g., $10M). No interest, no maturity date, no debt. The Post-Money SAFE (YC standard) is the modern default — it makes cap-table math predictable.",
            "Convertible note: technically debt — money plus interest (typically 6-8%), converting at the next round with a discount/cap, with a maturity date (usually 18-24 months). The maturity date is the risk: if no round happens, the note becomes due and must be repaid or converted by agreement.",
            "Priced round: actual preferred stock sold at a fixed valuation with a full term sheet (board seats, protective provisions, liquidation preference). More legal work, more control changes — usually the 'real' institutional step.",
          ],
        },
        {
          heading: "How to choose",
          paragraphs: [
            "Seed/pre-seed from angels and syndicates: SAFEs — fast, cheap, standardized. The Post-Money SAFE's beauty: you know your dilution per dollar immediately. If you're raising $1M on a $10M cap, each $100K is 1% post-money — do the math in your head at the dinner table.",
        ...
        },
        {
          ...
          paragraphs: [
            "Cap = the maximum valuation at which the money converts (your investor gets equity at min(round valuation, cap), less the discount). A $10M cap means: whatever the round's price, your SAFE investor pays as if the company were worth $10M — and gets a 10-20% discount on top.",
            "Cap arithmetic: $500K at a $10M cap converts to 5% at $10M round valuation (with post-money SAFE). If the round comes at $20M, the SAFE still converts at $10M — the investor is rewarded for early risk, and you gave up more than the $20M number suggests. This is why founders negotiate caps hard and investors love them.",
            "The 'valuation cap creep' problem: consecutive rounds with caps inflate the implied valuation until the real priced round hits a wall. Keep caps honest — a cap 3x above your realistic comp set is a time bomb.",
          ],
        },
      ],
      examples: [
        "A founder raises $750K on a $12M cap with 20% discount. Next year the seed round comes at a $15M pre. Each SAFE dollar converts at min($12M cap, $15M round) minus 20% — effectively an $9.6M valuation for those dollars. The founder realizes the cap he signed was the real valuation all along.",
        "Another founder uses notes with 18-month maturity. The market turns, no round happens in 18 months, and the notes come due — he now owes $400K+interest or must negotiate a conversion the investors don't need to agree to. The SAFE's lack of a maturity date was the gift he should have taken.",
      ],
      actionItems: [
      ...
      keyPoints: [
        "SAFE = no debt, no interest, no maturity — converts with discount + cap at next round.",
      ...
      sections: [
        {
          ...
          paragraphs: [
            "The narrative arc that works: a personal, specific problem (start with a moment, not a market size) → the failed alternatives (why existing solutions don't work — this is where you show you understand the space) → your solution and why it's fundamentally better → the evidence (traction, testimonials, numbers) → the market and the wave (why now) → the team (why you can win) → the ask (what you need and what it buys).",
            ...
            "Talk about competitors without flinching: 'we compete with X, they do A well, we're different on B because C.' Investors want conviction, not blindness — the founder who can't name their real competitor reads as someone who hasn't looked.",
          ],
        },
        {
          heading: "The evidence stack",
          paragraphs: [
            "Evidence hierarchy: revenue (best), paying customers (very good), users with real usage (good), interviews/letters of intent (weak but real), opinions (no). Structure your pitch so the evidence you have is the center of gravity. If you only have opinions, your narrative should be shorter and your focus sharper — 'this is the problem, here's the team, here's what we'll prove in 6 months.'",
            "Traction slides should be one number per line, trending up, with the method labeled: 'Revenue (subscriptions, not refunds)', 'Users (DAU/MAU)', 'Retention (W4 cohort)', 'Pipeline (qualified, not leads)'. Labels prevent the question 'how is this counted?' — the question you don't want in the meeting.",
          ],
        },
        {
          heading: "The 'why now' and 'why you'",
          paragraphs: [
            "Why now: a market that's ready — regulation change, tech shift, adoption inflection, an economic tailwind. 'The data shows buyers have started spending on X in the last 18 months' is a wave. 'We've been building for two years' is not a wave.",
            "Why you: your unfair advantage — insight (you've lived the problem), access (you know the buyers), speed (you've shipped fast), or compounding defensibility (data, network effects). 'Passion' is not an unfair advantage; 'I ran a logistics company for 8 years and lost $2M to this exact problem' is.",
          ],
        },
      ],
      examples: [
        "A founder opens with 'I spent three years running a restaurant group and watched $80K/yr walk out the door in food waste.' That's a story. The same founder opening with 'the global food waste market is $1T' gets a different — worse — audience posture.",
        "A team pitches 'we're building an AI assistant for doctors.' The VC asks 'what's your unfair advantage?' The answer — 'we're faster' — fails. The same team, with one member who spent 10 years in clinical IT and two healthcare contracts signed, converts the room.",
      ],
      actionItems: [
    ...
    },
    {
      ...
      sections: [
        {
          ...
          paragraphs: [
            ...
            "The pattern to know: if you're not being asked for the next meeting, you're not progressing — and 'we'll circle back' means no. Ask directly at the end of every meeting: 'What would you need to see to move forward?'",
          ],
        },
        {
          heading: "The demo that sells",
          paragraphs: [
            "A live demo is your single most persuasive artifact. Structure: 1-minute setup (the problem the product solves in the user's words), 3-minute walkthrough of the core job (the happy path — not settings, not edge cases), 1-minute payoff (the result — the number, the saved hour, the avoided error). Practice until it runs without hunting for buttons.",
            "Demo do's: use real data (a real customer's story), fail gracefully (when something breaks, say 'the interesting thing about this edge case is...'), and end with the wow moment — the thing the audience will retell. Demo don'ts: no sandbox demos with dummy data, no 30-minute click-throughs, no apologizing for the UI.",
          ],
        },
        {
      ...
      examples: [
        "A founder treats the first call as a full pitch, monologuing for 20 minutes. The investor asks three questions and the call ends without a next step. The lesson: first calls are filters — compress, listen, and ask for the next meeting.",
        "Another founder ends every meeting with 'what would you need to see to move forward?' One investor says 'a customer reference from a named enterprise.' She sends it the same day — and moves to partner meeting in 48 hours. The question turned passive interest into an actionable path.",
      ],
      actionItems: [
    ...
    },
    {
      ...
      sections: [
        {
          ...
          paragraphs: [
            ...
            "The deadline move: give every investor a real or soft deadline ('we're looking to close in 3 weeks to hit a milestone'). Deadlines are honest if your round size and timeline are real; they're manipulation if invented — and investors can smell a fake deadline from across the room.",
          ],
        },
        {
          heading: "Deal flow hygiene",
          paragraphs: [
            "Log every conversation: contact, date, stage (intro → call → meeting → DD → term sheet), and the open question. Fundraising chaos — unanswered emails, double-booked calls, lost threads — reads as operational weakness. A clean pipeline is a signal.",
      ...
      actionItems: [
        ...
        "Build the tracker: target, stage, next action, owner — update it daily during the raise.",
        "Score each offer on strategy, governance, relationship, follow-on, price — before you're holding two.",
      ],
      keyPoints: [
    ...
    },
    {
      ...
      sections: [
        ...
        },
        {
          ...
          paragraphs: [
            "Financial: 'walk me through your burn' — know your burn monthly and seasonally. 'What's your path to profitability?' — have the model. 'Why is this line item what it is?' — every number has a story; know them all. Legal: 'who owns the IP?' — answers are: the company, per signed assignments. Anything else is a problem.",
            "Technical: 'how does the system scale?' — the honest answer at seed is 'we're built to refactor; here's our plan.' Pretending your monolith is infinitely scalable is a bigger red flag than the monolith. Commercial: 'talk to three customers' — warm references are normal; just make sure they're real users, not your friends.",
          ],
        },
        {
          heading: "Diligence as a relationship",
          paragraphs: [
            "Diligence is where trust is built or lost. Answer fast, answer completely, and surface problems before they're found ('our churn in Q1 was bad — here's why and here's the fix'). Investors would rather fund a founder who finds their own problems than one who hides them.",
            "The end state: a signed term sheet, legal review, and a close. Plan the close checklist: subscriber docs, funds wired, cap table updated, Form D filed, announcement agreed with the lead. Closing is not the finish line — the first board meeting and your reporting cadence are.",
          ],
        },
      ],
      examples: [
        ...
        "Another founder's financial DD reveals a $30K 'marketing' line that's actually a personal expense. He hides it; it surfaces; the deal dies. The same founder, surfaced it himself with a fix, would have closed — investors fund honesty.",
      ],
      actionItems: [
    ...
    },
    {
      ...
      sections: [
        {
          ...
          paragraphs: [
            "Closing = all investors' subscription documents signed, funds in the company's bank account, and the cap table updated to reflect the new money. For SAFE rounds: each investor signs the SAFE + wires; you countersign and issue the receipt — typically a same-day or same-week process per investor.",
        ...
        },
        {
          ...
          paragraphs: [
            "The week after close: (1) update the cap table and ledger, (2) file Form D within 15 days (SEC), (3) add investor info to the data room, (4) open your reporting cadence (monthly metrics, quarterly updates), (5) schedule the first board meeting, (6) update the website/marketing where appropriate, and (7) send a thank-you with the closing summary — investors remember how the close felt.",
            "The money itself: move to the operating account, wire carefully (verify accounts twice — fraud on wire instructions is real), and connect it to your accounting from day one so the bank matches the books.",
          ],
        },
        {
          heading: "The investor relationship you just signed up for",
          paragraphs: [
            "You now have partners, not customers. The relationship is maintained by the monthly update: what you did, the numbers, what's hard, what you need help with. Updates are not optional PR — they're the trust engine that powers your next round, warm intros, and help when you're in trouble.",
      ...
      examples: [
        "A founder receives a 'changed wire instructions' email from her lead investor's 'counsel' two days before close. She calls the investor on a verified number first — the email was a scam. She verifies every wire twice and closes clean, having learned the fraud rule on day one instead of the hard way.",
        "Another founder closes and goes silent for five months. When he needs a bridge round, his updates resume — but the investors who would have helped now remember the silence. The bridge takes 3x longer with worse terms.",
      ],
      actionItems: [
    ...
    },
    {
      ...
      sections: [
        {
          ...
          paragraphs: [
            "'No' comes in three flavors: (1) 'not right now' (timing, stage, sector — often real), (2) 'not you' (the team read as not ready — painful but actionable), (3) 'not at this price' (interest but a terms problem — the most useful). Extract which one you got at the end of every meeting: 'what would change your mind?' is the question that converts a no into information.",
        ...
        },
        {
          ...
          paragraphs: [
            "A round that doesn't close is a normal outcome — most seed attempts fail. The response is a sequence: (1) stop the burn of the raise (pause outreach), (2) extend runway (cut burn, raise small bridge from believers — customers, angels, debt), (3) redefine the milestone to something credible and achievable, (4) restart in 6-9 months with the new evidence.",
            "The failure mode to avoid: raising the same deck to the same list for a year. That's not persistence, it's noise. The market is telling you what it needs — the milestone. Go build it.",
      ...
      examples: [
        ...
        "Another founder keeps cold-emailing the same 80 investors every quarter for 18 months with the same deck. Response rate goes from 5% to zero. The market answered — he just didn't read the reply.",
      ],
      actionItems: [
        "Add the question to every meeting script: 'What would change your mind?'",
        "After 10+ rejections, classify the pattern: too early / team / price — then act on the category.",
  ...
  quiz: [
    ...
    },
    {
      ...
      correctIndex: 2,
      explanation: "The Post-Money SAFE computes dilution on post-money basis — every dollar's dilution is known instantly.",
    },
    {
      ...
      correctIndex: 1,
      explanation: "The cap is the valuation ceiling for conversion — investors convert at min(round value, cap), minus discount.",
    },
    {
