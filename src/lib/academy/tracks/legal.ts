...
export const legalTrack: AcademyTrack = {
  ...
  lessons: [
    {
      ...
      sections: [
        {
          ...
          paragraphs: [
            ...
            "An LLC is pass-through taxed (profits flow to owners, taxed once on personal returns), flexible in how it allocates ownership, and cheap to maintain. A C-Corp is a separate taxable entity (the company pays corporate tax, shareholders pay tax on dividends â€” 'double taxation'), but it can issue preferred stock, run an option pool, and use the standard documents every investor expects.",
            "The trap founders fall into: building a VC-bound company as an LLC because it felt simpler, then paying a taxable conversion later. Or the opposite â€” paying Delaware franchise fees and double-taxed salaries for a business that will never raise.",
          ],
        },
        {
          heading: "The decision framework",
          paragraphs: [
            "Raise venture money now or within ~24 months â†’ Delaware C-Corp. Run a profitable services or product business with no institutional money â†’ LLC (often in your home state). Plan to take on a strategic partner or be acquired by a larger company â†’ C-Corp usually, because acquirers want a clean equity structure.",
        ...
        },
        {
          ...
          paragraphs: [
            ...
            "If you never expect institutional investors, incorporate where you operate to avoid Delaware's annual franchise tax and foreign-qualification filings. Either way, do it once, correctly, with a service or lawyer â€” amateur incorporation errors surface at the worst moment: diligence.",
          ],
        },
      ],
      examples: [
        "Maya wants to raise a $1.5M seed in 12 months. She chooses a Delaware C-Corp even though she's a solo founder in Texas â€” the conversion cost of doing it later (a taxable event) far exceeds the ~$300/yr Delaware fees.",
      ...
      actionItems: [
        "Write one paragraph: 'Will I seek VC funding within 24 months? Yes/No â€” and why.'",
      ...
      keyPoints: [
        "VC-bound â†’ Delaware C-Corp. Bootstrapped â†’ LLC.",
        "LLC = pass-through tax, flexible, cheap. C-Corp = preferred stock, option pools, standard docs.",
        "Converting LLCâ†’C-Corp later is a taxable event.",
    ...
    },
    {
      ...
      sections: [
        {
          ...
          paragraphs: [
            ...
            "Services like Stripe Atlas, Clerky, or a startup lawyer handle steps 2-5 for a flat fee. What they cannot do is make your founder decisions â€” ownership split, vesting, and IP â€” which are the real work.",
            "The order matters less than completeness. The classic screw-up: incorporating, then operating for six months as if the entity didn't exist â€” signing contracts personally, paying personal cards â€” which blurs liability protection and creates a mess in diligence.",
          ],
        },
        {
          heading: "The 83(b) election â€” non-negotiable",
          paragraphs: [
            "When you receive restricted stock (shares subject to vesting), the IRS treats the spread between fair market value and your purchase price as ordinary income as each tranche vests. If you bought shares at par (pennies), the FMV is also low at grant â€” so the tax on the spread is tiny if you file an 83(b) election within 30 days of receiving the shares.",
            "Miss the window and you cannot file later (with rare exceptions). Each vesting tranche then gets taxed at its then-current FMV â€” and if the company grew, that's ordinary income on a large amount, on top of your salary. Founders have owed six figures for a mistake that cost one hour and one stamp.",
      ...
      examples: [
        "Nina files her 83(b) election by certified mail the same day she signs her founder shares. Two years later the company is worth $20M â€” her early filing kept her founder tax bill to hundreds of dollars instead of millions in ordinary income.",
        "A founder misses 83(b). His company later raises at a $30M valuation and his first vesting tranche is taxed at FMV â€” a bill bigger than his annual salary.",
      ],
      actionItems: [
        ...
        "Buy the domain and check USPTO TESS for your name â€” 10 minutes, do it now.",
      ],
      keyPoints: [
        "Incorporation = file, issue shares, bylaws, EIN, bank account, taxes.",
        "File the 83(b) within 30 days â€” certified, duplicated, with proof.",
    ...
    },
    {
      ...
      sections: [
        {
          ...
          paragraphs: [
            ...
            "The most expensive sentence in early startup history is 'we're all founders, we'll figure it out.' Figure it out now, in writing. The agreement does not need to be long â€” it needs to be explicit.",
            "Key clauses to get right: buyback rights (company can repurchase unvested shares from a departing founder at cost), garden-leave or non-compete scope (state-dependent â€” enforceability varies wildly), and what happens to IP created before incorporation (signed over in writing).",
          ],
        },
        {
          heading: "IP assignment â€” the invisible moat",
          paragraphs: [
            ...
            "The contractor CIIAA is the one founders forget. A contractor who writes your code without an assignment agreement may legally own that code. Fixing it later means a retroactive assignment (possible but legally fragile â€” and contractors have leverage).",
      ...
      examples: [
        "Two founders split 50/50 verbally. After 9 months one quits. There's no buyback clause, so the leaver keeps 50% of a company they don't work for â€” a dead company, because nobody will invest into that structure.",
      ...
      keyPoints: [
        "Founder agreement: split, vesting, IP, roles, exit â€” explicit and written.",
    ...
    },
    {
      ...
      sections: [
        {
          ...
          paragraphs: [
            ...
            "Founders sometimes negotiate accelerated vesting on acquisition (e.g., 50% of unvested shares accelerate if the company is sold) â€” a retention and incentive tool that also shapes acquisition math.",
          ],
        },
        {
          heading: "The option pool â€” who really pays",
          paragraphs: [
            "The option pool is the block of shares reserved for future employees, typically 10-20% of the company. It's created before (or at) a priced round, and here's the crux: the pool is carved out of the PRE-money valuation, so it dilutes the founders â€” not the new investors. A $10M pre-money with a 20% pool means founders' equity is effectively valued at $8M.",
        ...
        },
        {
          ...
          paragraphs: [
            "Model: start with 10,000,000 shares. Founders own 6M, option pool 2M, reserve 2M. Now you raise $2M at $8M pre-money â†’ investor gets 20% (2M post / 10M post). The pool is NOT part of your ownership â€” it belongs to future hires. When an employee vests pool shares, the pie is fixed; everyone dilutes proportionally.",
      ...
      examples: [
        "A founder proposes a 20% pool at a $5M pre-money raise. The founders compute: effective valuation for founders = $5M Ã (1 âˆ’ 0.20) = $4M. They counter with 12% and an agreement to top up at Series A â€” keeping $400K of value.",
        "An early engineer's 0.5% grant vests over 4 years with a cliff. She leaves at month 14, keeping her 25% + 2 months â€” a trivial cost to the company, and exactly the alignment that protects it.",
      ],
      actionItems: [
      ...
      keyPoints: [
        ...
        "The option pool dilutes founders, not new investors â€” negotiate the number.",
    ...
    },
    {
      ...
      sections: [
        ...
        },
        {
          ...
          paragraphs: [
            "Indemnification: who is liable if your software breaks something at a customer? Unbounded indemnities from a startup are a risk you can't price. Limitation of liability: standard is 'liability capped at fees paid' â€” anything above that is a red flag for an early-stage company. Auto-renewal: when does this contract silently renew and can you exit? IP ownership: does the work-for-hire clause actually assign the work?",
            "Also watch 'most favored nation' pricing clauses (a big customer can retroactively force you to match a cheaper deal you give anyone else) and exclusivity â€” both can box you in.",
          ],
        },
        {
          ...
          paragraphs: [
            ...
            "Keep every signed contract in a folder with the counterparty, date, and parties â€” your data room starts here.",
          ],
        },
      ],
      examples: [
        "A startup signs a customer's MSA with an uncapped indemnity. Their software has an outage that costs the customer $300K in lost sales â€” and the startup, not its insurer, is on the hook because liability was never capped.",
    ...
    },
    {
      ...
      sections: [
        {
          ...
          paragraphs: [
            ...
            "Accredited investor thresholds (current): net worth over $1M excluding primary residence, OR income over $200K (or $300K joint) in each of the last two years. Newer rules also allow investments based on 'knowledgeable employee' or revenue-based tests for certain funds â€” but for a startup raising from individuals, the classic tests apply.",
            "Non-accredited investors: taking them under 506(b) is legal but every state has its own registration requirements (merit review) that are a compliance maze. Most founders simply raise from accredited investors only â€” cleaner, and most angel money is accredited anyway.",
          ],
        },
        {
          heading: "Anti-fraud rules apply to everything",
          paragraphs: [
            "Rule 10b-5: no misleading statements or omissions, in ANY medium, to anyone. That includes your website, your pitch email, your podcast appearance, and what you tell the press. 'Raising a $2M round at a $15M valuation' that is actually a $1M round at a $5M valuation is fraud â€” even if it's what 'everyone says.'",
            "The practical consequence: keep your public claims defensible. If you say '500 customers,' be able to show 500. If your ARR is 'run-rate,' label it. Diligence will test every claim you made in public â€” and investors who catch a stretch stop believing everything else.",
          ],
        },
        {
          ...
          paragraphs: [
            ...
            "If you use a platform or a lead investor with a fund, confirm they handle 506(c) verification and KYC â€” don't assume.",
          ],
        },
        {
          heading: "State level",
          paragraphs: [
            "Federal exemption doesn't automatically exempt state 'blue sky' laws. Under the JOBS Act, 506 offerings preempt most state registration (with notice filings in some states). For 506(b) with only accredited investors, most states require only a notice filing or nothing. Check the states where your investors reside â€” this is a two-page form, not a reason to panic, but it's real.",
          ],
        },
      ],
      examples: [
        "A founder says in a demo-day pitch 'we're raising $2M at $20M post' â€” but the actual terms are a $1.5M SAFE with no valuation. An investor's lawyer sees the mismatch, the investor pulls out, and the founder's credibility is gone.",
        "Under 506(c), a founder markets publicly but only verifies one investor's status after wiring. The SEC later asks for documentation â€” she has none. Best case, fines; worst case, rescission rights for investors.",
      ],
      actionItems: [
      ...
      keyPoints: [
        ...
        "Anti-fraud (10b-5) applies to every public statement â€” keep claims defensible.",
        "File Form D within 15 days; keep verification records per investor.",
        "Blue-sky notice filings vary by state â€” check where investors live.",
      ],
    },
    {
      id: "legal-7",
      ...
      sections: [
        ...
        },
        {
          ...
          paragraphs: [
            "Investors' lawyers ask for: your privacy policy URL, DPA coverage with key vendors, evidence of a breach-response plan, and whether you process special-category data. You don't need a compliance department â€” you need a documented, sensible framework and a policy that matches reality (a privacy policy that promises things your code doesn't do is worse than none).",
          ],
        },
      ],
      examples: [
        ...
        "A founder uses an AI API that trains on inputs. Support tickets containing customer names go in. A customer's lawyer asks where their data is. The answer â€” 'an AI model someone else trained on it' â€” ends the deal.",
      ],
      actionItems: [
      ...
      keyPoints: [
        ...
        "You're the controller; vendors are processors â€” DPAs required.",
    ...
    },
    {
      ...
      sections: [
        {
          ...
          paragraphs: [
            "General Liability (slips, physical damage) â€” cheap, often required by landlords. Errors & Omissions / Professional Liability (claims your product or advice caused financial harm) â€” increasingly required by B2B customers. Workers' Compensation (once you have employees, required by law in most states). Cyber/Data Breach liability (if you store customer data or take payments).",
        ...
        },
        {
          ...
          paragraphs: [
            "D&O covers the board and founders against claims of mismanagement. Investors' diligence will often require the company to carry D&O (or at least note its absence). It's not about what you'll do wrong â€” it's that boards get sued when things go wrong, and defense costs alone are enormous.",
        ...
        },
        {
          ...
          paragraphs: [
            "Insurance is a diligence checkbox, not a strategy. Your time is better spent on the operating risks (security, contracts) than optimizing premiums. Get one broker quote across the stack, buy the required pieces, and move on â€” then revisit at Series A when requirements tighten.",
          ],
        },
      ],
      examples: [
        "A B2B startup's first enterprise customer's procurement says 'no E&O policy, no contract.' The $50K deal hinges on a $1,200/year policy â€” an obvious buy.",
      ...
      keyPoints: [
        ...
        "D&O is an investor diligence checkbox â€” ask what they require.",
        "Insurance is a checkbox, not a strategy â€” one quote, move on.",
      ],
    },
    {
      id: "legal-9",
      ...
      sections: [
        {
          ...
          paragraphs: [
            "A term sheet has two halves. The economics (valuation, price, pool, liquidation) determine how the pie is split. The control (board, protective provisions, voting, drag-along) determine who steers. Founders over-index on valuation and under-index on control â€” the opposite of what usually bites later.",
        ...
        },
        {
          ...
          paragraphs: [
            "Liquidation preference: preferred get their money back before common. 1x non-participating = they get 1x their investment, then the rest splits per ownership â€” the fair baseline. 1x participating = they ALSO get their percentage on top (double-dipping) â€” push back. 2-3x preferences are founder-hostile.",
            "Board: 1 seat with VC (typical seed), or 2-1-1 with an independent at Series A. More investor seats = more control. Pay attention to who appoints the independent â€” deadlocks break toward whoever picked the tiebreaker.",
            "Protective provisions: the investor veto list â€” selling, changing capital structure, issuing more shares, changing the business, taking on significant debt. 'Significant' is negotiated; a wide veto list is death by a thousand cuts.",
            "Pro-rata rights: investors can buy their share of future rounds â€” good (they can support you) unless your future rounds need new money and existing holders don't participate (a 'blow-up' of your cap table).",
        ...
        },
        {
          ...
          paragraphs: [
            "Vesting on founder shares (re-vesting requirements are common on new money), no-shop clauses (can't talk to other investors for X days â€” fine at 30-45 days), exclusivity, and expenses. The data-rights clause (monthly/quarterly reports to investors) is standard â€” budget for the reporting cadence.",
            "Rule: the term sheet is a summary; the definitive agreements (Stock Purchase Agreement, Amended Charter, Investors' Rights, Voting, Right of First Refusal & Co-Sale) are where the detail lives. Get a lawyer who does startup financing â€” this is not DIY.",
          ],
        },
      ],
      examples: [
        "Founder A takes a $3M seed with a 2x participating preference, happy about the 'high' valuation. A $5M exit later: investors take 2Ã$3M = $6M (the entire exit) and the founders get $0 â€” a 'liquidation overhang' that makes small exits worthless to founders.",
        "Founder B negotiates a 1x non-participating preference, pro-rata with a participation floor for future rounds, and a 2-1-1 board. Same exit: investors take their $3M back, and $2M splits among the equity holders â€” founders actually earn from the outcome.",
      ],
      actionItems: [
        "Model the exit math for 1x non-participating vs 2x participating at 3 exit sizes (1Ã, 3Ã, 10Ã of investment).",
      ...
      keyPoints: [
        ...
        "The term sheet is a summary â€” the definitive agreements are where it's decided.",
      ],
    },
    {
      id: "legal-10",
      ...
      sections: [
        {
          ...
          paragraphs: [
            ...
            "Investors also ask for the 'why': customer pipeline, product metrics, and the working models behind your projections. Separate the legal data room from the business data room â€” lawyers want contracts, investors want numbers.",
          ],
        },
        {
        ...
        },
        {
          ...
          paragraphs: [
            "Keep the data room structured and access-controlled (not one big zip). Grant view-only access; track who looked at what. Expect three rounds of questions â€” answer fast and completely. Slow or evasive answers are read as red flags even when the answer is fine.",
            "After close: update the cap table, file the amended documents, and archive the signed set â€” then set your investor-update and board cadence immediately.",
          ],
        },
      ],
      examples: [
        "A founder invites a lead investor's counsel into her data room. In week 1, they find an unsigned IP assignment from her CTO. She produces it signed within a day because she'd pre-emptively done her own audit â€” the deal proceeds.",
  ...
  quiz: [
    ...
    },
    {
      ...
      correctIndex: 1,
      explanation: "83(b) must be filed within 30 days. Missing it taxes each vesting tranche at FMV â€” potentially huge ordinary income.",
    },
    {
    ...
    },
    {
      ...
      correctIndex: 1,
      explanation: "The pool is carved out of pre-money, so it dilutes founders and existing shareholders â€” not the new money coming in.",
    },
  ],
};
