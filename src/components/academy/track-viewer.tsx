...
function LockCard({
  ...
  return (
    <div className="mt-6 rounded-2xl border border-border bg-card p-8 text-center">
      <div className="mx-auto flex size-14 items-center justify-center rounded-full bg-brand-500/10">
      ...
      {countdown && (
        <div className="mx-auto mt-5 inline-flex items-center gap-2 rounded-xl border border-brand-500/30 bg-brand-500/10 px-5 py-2.5 font-mono text-lg font-bold text-brand-400">
...
i === lessonIndex
          ...
          <article className="rounded-2xl border border-border bg-card p-6 sm:p-8">
            ...
            {lesson.examples && lesson.examples.length > 0 && (
              <div className="mt-8 rounded-xl border border-brand-500/25 bg-brand-500/5 p-5">
                ...
                <ul className="mt-3 space-y-3">
                  {lesson.examples.map((example, i) => (
                    <li key={i} className="text-sm leading-relaxed text-foreground/80">
                      <span className="mr-1.5 font-semibold text-brand-700">
            ...
            <div className="mt-6 rounded-xl border border-brand-500/25 bg-brand-500/5 p-5">
              <p className="flex items-center gap-2 text-xs font-semibold uppercase tracking-wide text-brand-700">
            ...
            <div className="mt-8 flex flex-wrap items-center justify-between gap-3">
              ...
              {!completed.includes(lesson.id) ? (
                <button
                  ...
                  disabled={marking}
                  className="flex items-center gap-1 rounded-lg bg-brand-500 px-4 py-2 text-sm font-semibold text-white shadow-lg shadow-brand-500/25 transition-opacity disabled:opacity-50"
                >
              ...
              {lessonIndex < track.lessons.length - 1 ? (
                <button
                  ...
                  className="flex items-center gap-1 rounded-lg bg-brand-500 px-4 py-2 text-sm font-semibold text-white shadow-lg shadow-black/25"
                >
                ...
                <button
                  ...
                  disabled={!canQuiz}
                  className="flex items-center gap-1 rounded-lg bg-brand-500 px-4 py-2 text-sm font-semibold text-white shadow-lg shadow-black/25 disabled:opacity-40"
                >
          ...
          {canQuiz && !quizLocked && (
            <>
                    ...
                    {q.options.map((option, oi) => (
                      <button
                        ...
                        className={cn(
                          ...
                          quizAnswers[qi] === oi
                            ? "border-brand-500/50 bg-brand-500/10 font-medium text-foreground"
              ...
              <button
                ...
                className="flex w-full items-center justify-center gap-2 rounded-xl bg-brand-500 px-6 py-3.5 text-sm font-semibold text-white shadow-lg shadow-brand-500/25 transition-opacity disabled:opacity-40"
              >
            ...
            <>
              {examScore !== null && (
                <div className="flex items-center justify-between rounded-xl border border-border bg-card px-5 py-3 text-sm">
                  ...
                  <span className={cn("font-bold", examPassed ? "text-brand-700" : "text-foreground")}>
              ...
              <div className="rounded-xl border border-brand-500/25 bg-brand-500/5 px-5 py-4">
                <p className="text-sm text-muted-foreground">
                  <span className="font-semibold text-brand-700">Final exam</span> ·{" "}
      ...
      {mode === "result" && result && (
        <div className="mt-6 rounded-2xl border border-border bg-card p-8 text-center">
          <div className="mx-auto flex size-16 items-center justify-center rounded-full bg-brand-500/10">
            {result.passed ? (
              result.kind === "exam" ? (
          ...
          {!result.passed && (
            <div className="mt-6 space-y-3 text-left">
              ...
              <div className="rounded-xl border border-brand-500/25 bg-brand-500/10 px-5 py-4">
              ...
              <div className="flex flex-col justify-center gap-3 sm:flex-row">
                {result.kind === "exam" ? (
                  <Link
                    ...
                    className="flex items-center justify-center gap-2 rounded-lg bg-brand-500 px-5 py-3 text-sm font-semibold text-white shadow-lg shadow-brand-500/25"
                  >
