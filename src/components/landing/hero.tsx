...
export default function Hero() {
  return (
    <section className="relative overflow-hidden bg-background">
      ...
      <div className="pointer-events-none absolute -top-48 left-1/2 -z-10 h-[520px] w-[900px] -translate-x-1/2 rounded-full bg-secondary/10 blur-3xl" />
      ...
      <div className="relative mx-auto max-w-7xl px-4 pb-20 pt-16 sm:px-6 lg:px-8 lg:pt-24">
        ...
        >
          <div className="animate-float rounded-2xl border border-border bg-card shadow-2xl shadow-card/10">
            ...
            <div className="grid sm:grid-cols-2">
              <div className="space-y-4 border-b border-border p-6 sm:border-b-0 sm:border-r">
                ...
                <div className="flex h-10 w-full items-center justify-center rounded-lg bg-secondary text-sm font-semibold text-white shadow-lg shadow-black/25 ring-1 ring-secondary">
                  Generate my deck
                </div>
              </div>
              <div className="p-6">
