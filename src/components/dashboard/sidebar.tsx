        ...
        return (
          <Link
            ...
            className={cn(
              ...
              active
                ? "bg-slate-800/90 text-steel-300 shadow-sm"
          ...
          >
            ...
            {item.comingSoon && (
              <span className="shrink-0 rounded-full bg-steel-600/15 px-1.5 py-0.5 text-[9px] font-black uppercase tracking-wider text-steel-300 ring-1 ring-steel-500/30">
                Soon
              </span>
            )}
          </Link>
  ...
  return (
    <div className="border-t border-slate-800 p-3">
      <div className="flex items-center gap-3 rounded-lg px-2 py-2">
        <span className="flex size-9 shrink-0 items-center justify-center rounded-full bg-slate-700 text-xs font-bold text-white">
          {initials(user.name)}
        </span>
    ...
    <>
      <aside className="fixed inset-y-0 left-0 z-50 hidden w-64 flex-col bg-navy-950 lg:flex">
        ...
        <div className="mt-4 flex flex-1 flex-col">
          <div className="mb-2 flex items-center gap-2 rounded-lg border border-steel-500/25 bg-steel-600/10 px-3 py-2">
            <Sparkles className="size-3.5 shrink-0 text-steel-300" />
